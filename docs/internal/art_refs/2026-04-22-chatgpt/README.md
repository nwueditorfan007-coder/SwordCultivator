# 2026-04-22 ChatGPT Art References

这组图片是用于 `SwordCultivator` demo 的内部参考美术资源，不作为正式游戏资产直接使用。

- 来源：`C:/Users/Han_112/Downloads/ChatGPT Image 2026年4月22日 *.png`
- 归档日期：`2026-04-22`
- 用途：HUD 方向、阵图舞台气质、飞剑出击构图、敌我颜色关系、技能栏摆位

## 文件索引

| File | Original Source | Focus |
| --- | --- | --- |
| `ref-01-diagonal-recall-strike.png` | `ChatGPT Image 2026年4月22日 16_44_41.png` | 大斜切主剑势、飞剑回收提示、极简左上状态栏 |
...
- 优先把这组图当作 `moodboard` 和构图参考，而不是逐像素临摹目标。
- 当前项目更适合吸收 `ref-04`、`ref-05`、`ref-07` 的结构克制感，再借一点 `ref-01`、`ref-06` 的氛围完成度。
- 如果后续继续补图，按日期新建子目录，避免把不同轮次参考图混在一起。
