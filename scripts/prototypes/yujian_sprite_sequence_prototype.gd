...
const LEVEL_01_BACKGROUND_PROFILE_PATH := "res://resources/flight/background/level_01_immortal_sea_background.json"
...
const BACKGROUND_ISLAND_GROUPS := [
	...
	{"x": 11800.0, "depth": 0.54, "scale": 0.76, "sea_offset": 42.0, "alpha": 0.84, "landmark": 0, "landmark_scale": 0.52},
	{"x": 13750.0, "depth": 0.50, "scale": 0.62, "sea_offset": 34.0, "alpha": 0.78, "landmark": 2, "landmark_scale": 0.42, "mirror": true},
	{"x": 15150.0, "depth": 0.46, "scale": 0.58, "sea_offset": 14.0, "alpha": 0.70, "landmark": 1, "landmark_scale": 0.38},
	{"x": 16600.0, "depth": 0.38, "scale": 0.56, "sea_offset": -10.0, "alpha": 0.68, "landmark": 4, "landmark_scale": 0.38, "mountain": "far"},
...
@export var 天空中部颜色 := Color(0.68, 0.86, 0.94, 1.0)
@export var 天空底部颜色 := Color(0.95, 0.98, 0.92, 1.0)
@export_range(0.0, 0.30, 0.005) var 天空中部雾光强度 := 0.12
@export_range(0.0, 0.30, 0.005) var 天空低处青雾强度 := 0.045

@export_group("海平面")
@export_range(0.35, 0.72, 0.001) var 海平线高度比例 := 0.515
@export var 海面基础颜色 := Color(0.03, 0.38, 0.82, 1.0)
...
@export_range(0.0, 1.0, 0.005) var 地标建筑透明度 := 0.34
@export_range(0.0, 120.0, 1.0) var 岛屿入水遮挡高度 := 42.0
@export_range(0.0, 1.0, 0.005) var 岛屿入水遮挡透明度 := 0.34
@export_range(0.0, 1.0, 0.005) var 岛屿接触阴影透明度 := 0.045
...
func _draw_legacy_texture_background() -> void:
	_draw_sky_wash()
...
func _draw_soft_horizon_glow(horizon_y: float, alpha_scale: float) -> void:
	...
	var edge_color := Color(海平线柔光颜色.r, 海平线柔光颜色.g, 海平线柔光颜色.b, 0.0)
	var center_color := Color(
		海平线柔光颜色.r,
		海平线柔光颜色.g,
		海平线柔光颜色.b,
		海平线柔光强度 * alpha_scale * 海平线柔光颜色.a
	)
